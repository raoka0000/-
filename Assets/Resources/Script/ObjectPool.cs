...
public class ObjectPool : MonoBehaviour {
	...
	private Dictionary<int, List<GameObject>> _pooledGameObjects = new Dictionary<int, List<GameObject>> ();

	public Dictionary<int, List<GameObject>> pooledGameObjects{
		get{ return _pooledGameObjects; }
	}
